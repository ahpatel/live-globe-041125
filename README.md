...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/live-globe-041125)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/live-globe-041125
```

A live public deployment of this template is available at [https://live-globe-041125.templates.workers.dev](https://live-globe-041125.templates.workers.dev)
